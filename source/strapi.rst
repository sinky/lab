.. author:: Marco Krage <https://krage.nrw>
...
Strapi_ is a open source headless CMS written in JavaScript and distributed under the MIT License.
it features an admin backend to manage data which then is exposed through an REST api.
...
.. note::
    ...
    Strapi currently is designed to be served from the root of the domain.
    https://github.com/strapi/strapi/issues/4760
...
Use ``npm`` to install ``npx`` globally and create a new strapi project:

::

 [isabell@stardust ~]$ npm install -g npx
 + npx@10.2.2
 added 493 packages from 654 contributors in 14.993s
 [isabell@stardust ~]$ npx create-strapi-app my-project --quickstart
 Creating a new Strapi application at /home/isabell/my-project.
...
Tested with Strapi 3.0.0-beta.19.5, Uberspace 7.5.1.0
